...
public struct QuoteResponseQuotesItem: Codable, Hashable, Sendable {
    ...
    public let type: QuoteResponseQuotesItemType?
    ...
    public init(
        ...
        type: QuoteResponseQuotesItemType? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decodeIfPresent(QuoteResponseQuotesItemType.self, forKey: .type)
