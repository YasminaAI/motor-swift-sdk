...
public struct PaginatedPolicyResponse: Codable, Hashable, Sendable {
    ...
    public let aggregates: PolicyAggregates?
    ...
    public init(
        ...
        to: Nullable<Int>? = nil,
        total: Int? = nil,
        aggregates: PolicyAggregates? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try container.decodeIfPresent([Policy].self, forKey: .data)
        ...
        self.aggregates = try container.decodeIfPresent(PolicyAggregates.self, forKey: .aggregates)
