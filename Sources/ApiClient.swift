...
public final class ApiClient: Sendable {
    public let quotes: QuotesClient
    public let policies: PoliciesClient
    public let otPs: OtPsClient
    ...
    init(
        ...
        self.quotes = QuotesClient(config: config)
        self.policies = PoliciesClient(config: config)
        self.otPs = OtPsClient(config: config)
